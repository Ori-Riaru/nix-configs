{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-7217e1cc-f061-4baf-85ec-29dbd27d6731" = [ ];
      ...
      "kwin"."Switch to Next Desktop" = "Meta+R";
      "kwin"."Switch to Next Screen" = "none,,Switch to Next Screen";
      "kwin"."Switch to Previous Desktop" = "Meta+C";
      ...
      "kwin"."Window to Next Desktop" = "Meta+Shift+R";
      "kwin"."Window to Next Screen" = "Meta+Shift+Right";
      "kwin"."Window to Previous Desktop" = "Meta+Shift+C";
      ...
      "kwin"."karousel-window-move-down" = "Meta+Shift+N";
      "kwin"."karousel-window-move-end" = "Meta+Shift+End,none,Karousel: Move window to end";
      "kwin"."karousel-window-move-left" = ["Meta+Ctrl+Shift+Tab" "Meta+Shift+H"];
      "kwin"."karousel-window-move-next" = [ ];
      "kwin"."karousel-window-move-previous" = [ ];
      "kwin"."karousel-window-move-right" = ["Meta+Shift+S" "Meta+Shift+Tab"];
      ...
      "kwin"."karousel-window-move-up" = "Meta+Shift+T";
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,2,27,9,48,31.895";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."7217e1cc-f061-4baf-85ec-29dbd27d6731" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "7217e1cc-f061-4baf-85ec-29dbd27d6731";
      ...
      "kwinrc"."Activities/LastVirtualDesktop"."2319f347-e97d-4795-954b-ec63abf5f437" = "a5465a2b-0516-495c-b497-6f009ce28aab";
      "kwinrc"."Activities/LastVirtualDesktop"."7217e1cc-f061-4baf-85ec-29dbd27d6731" = "aa2557ce-8d45-418c-a13b-c6b547c03499";
      "kwinrc"."Desktops"."Id_1" = "8db940a9-179b-472a-a534-94b514071b90";
      "kwinrc"."Desktops"."Id_2" = "aa2557ce-8d45-418c-a13b-c6b547c03499";
      "kwinrc"."Desktops"."Id_3" = "5326a8af-b746-4bf8-87dc-a842f7ac011d";
      "kwinrc"."Desktops"."Id_4" = "a5b15319-d618-4be0-bea0-d320004939af";
      ...
      "kwinrc"."Tiling/2ead7e4f-5e19-509b-9828-309a3acb261b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
