{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-6af63d40-b5f1-4b3f-ab0e-79957dec5171" = [ ];
      ...
      "kwin"."KrohnkiteBTreeLayout" = "Meta+Num+End,none,Krohnkite: BTree Layout";
      ...
      "kwin"."Window Move" = "Ctrl+Shift+Right,,Move Window";
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,12,23,1,29,11.752";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."6af63d40-b5f1-4b3f-ab0e-79957dec5171" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "6af63d40-b5f1-4b3f-ab0e-79957dec5171";
      ...
      "kwinrc"."Desktops"."Id_1" = "d9c049ab-efb5-48a9-a137-616a0de78f2e";
      "kwinrc"."Desktops"."Id_2" = "a67023b9-7df3-4c1d-b5eb-74806a34d64f";
      "kwinrc"."Desktops"."Id_3" = "44566d84-500e-4e17-ab20-06fe7a8212b9";
      "kwinrc"."Desktops"."Id_4" = "e778088d-e261-419a-be3d-717bc3af7df2";
      "kwinrc"."Desktops"."Number" = 4;
      "kwinrc"."Desktops"."Rows" = 4;
      "kwinrc"."Effect-kwin4_effect_geometry_change"."Duration" = 260;
      ...
      "kwinrc"."PrimaryOutline"."InactiveOutlineAlpha" = 14;
      "kwinrc"."PrimaryOutline"."InactiveOutlineColor" = "255,255,255";
      "kwinrc"."PrimaryOutline"."InactiveOutlineThickness" = 2;
      "kwinrc"."PrimaryOutline"."OutlineColor" = "255,255,255";
      ...
      "kwinrc"."Script-krohnkite"."columnsLayoutInitialRotationAngle" = 1;
      ...
      "kwinrc"."Script-krohnkite"."screenGapTop" = 26;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/78d9aab6-16c8-5644-b03d-5f56f085532f"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/7c9ff068-8fbd-5761-ae69-4f31df8358e1"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/afdc989c-e7de-5f99-85fc-506c8aac9dc7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/ba5ce4cf-a419-5536-b8c4-d35454f3ede2"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Windows"."FocusPolicy" = "FocusFollowsMouse";
      "kwinrc"."Xwayland"."Scale" = 1;
      "kwinrc"."org.kde.kdecoration2"."theme" = "Breeze";
      "kwinrc"."ًRound-Corners"."AnimationEnabled" = false;
      "kwinrc"."ًRound-Corners"."InactiveCornerRadius" = 0;
      "kwinrc"."ًRound-Corners"."Size" = 0;
      ...
      "plasmarc"."Theme"."name" = "ROUNDED-COLOR-OPAQUE";
      "spectaclerc"."ImageSave"."lastImageSaveLocation" = "file:///home/riaru/Pictures/Screenshots/Screenshot_20241225_195338.png";
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/riaru/Projects/nix-configs/flake.nix";
      "kate/anonymous.katesession"."Document 1"."URL" = "file:///home/riaru/Projects/nix-configs/hosts/common/optional/audio.nix";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-H-Splitter" = "200,1320,0";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 875;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-2-Splitter" = 1521;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 1273;
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0"."Sizes" = 1320;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."ScrollLine" = 57;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 1"."CursorColumn" = 1;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 1"."CursorLine" = 10;
