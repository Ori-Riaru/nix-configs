{
  ...
  programs.niri.settings = {
    ...
    binds = {
      ...
      "Mod+L".action.spawn = ["sh" "-c" "${pkgs.python314Packages.python-kasa}/bin/kasa --host 192.168.1.68 --username 'ori-riaru@proton.me' --password $(cat ${config.sops.secrets.kasa_pass.path}) toggle"];
